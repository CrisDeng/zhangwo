...
const FIELD_LABELS: Record<string, string> = {
  ...
  "models.bedrockDiscovery": "Bedrock 自动发现",
  "models.bedrockDiscovery.enabled": "启用自动发现",
  "models.bedrockDiscovery.region": "AWS 区域",
  "models.bedrockDiscovery.providerFilter": "提供商过滤",
  "models.bedrockDiscovery.refreshInterval": "刷新间隔",
  "models.bedrockDiscovery.defaultContextWindow": "默认上下文窗口",
  "models.bedrockDiscovery.defaultMaxTokens": "默认最大 Token",
  // Provider 配置字段
  "models.providers.*.baseUrl": "API 基础 URL",
  "models.providers.*.apiKey": "API 密钥",
  "models.providers.*.auth": "认证模式",
  "models.providers.*.api": "API 协议",
  "models.providers.*.headers": "自定义请求头",
  "models.providers.*.authHeader": "请求头认证",
  "models.providers.*.models": "模型列表",
  // Model 定义字段
  "models.providers.*.models.*.id": "模型 ID",
  "models.providers.*.models.*.name": "模型名称",
  "models.providers.*.models.*.api": "API 协议",
  "models.providers.*.models.*.reasoning": "推理能力",
  "models.providers.*.models.*.input": "输入类型",
  "models.providers.*.models.*.contextWindow": "上下文窗口",
  "models.providers.*.models.*.maxTokens": "最大 Token",
  "models.providers.*.models.*.headers": "自定义请求头",
  "models.providers.*.models.*.cost": "成本配置",
  "models.providers.*.models.*.cost.input": "输入成本",
  "models.providers.*.models.*.cost.output": "输出成本",
  "models.providers.*.models.*.cost.cacheRead": "缓存读取成本",
  "models.providers.*.models.*.cost.cacheWrite": "缓存写入成本",
  "models.providers.*.models.*.compat": "兼容性配置",
  "models.providers.*.models.*.compat.supportsStore": "支持存储",
  "models.providers.*.models.*.compat.supportsDeveloperRole": "支持开发者角色",
  "models.providers.*.models.*.compat.supportsReasoningEffort": "支持推理强度",
  "models.providers.*.models.*.compat.maxTokensField": "最大 Token 字段名",
};
...
const FIELD_HELP: Record<string, string> = {
  ...
  // Models 配置帮助信息
  "models.mode": "配置模式：'merge' 将与内置配置合并，'replace' 将完全替换内置配置。",
  "models.providers": "模型提供商配置，键名为提供商标识（如 openai、anthropic 等）。",
  "models.bedrockDiscovery": "AWS Bedrock 模型自动发现配置。",
  "models.bedrockDiscovery.enabled": "是否启用 AWS Bedrock 模型自动发现。",
  "models.bedrockDiscovery.region": "AWS 区域标识（如 us-east-1）。",
  "models.bedrockDiscovery.providerFilter": "仅发现指定提供商的模型（如 ['anthropic', 'meta']）。",
  "models.bedrockDiscovery.refreshInterval": "自动发现刷新间隔（毫秒）。",
  "models.bedrockDiscovery.defaultContextWindow": "发现的模型默认上下文窗口大小。",
  "models.bedrockDiscovery.defaultMaxTokens": "发现的模型默认最大输出 Token 数。",
  "models.providers.*.baseUrl": "提供商 API 的基础 URL（如 https://api.openai.com/v1）。",
  "models.providers.*.apiKey": "API 访问密钥。",
  "models.providers.*.auth":
    "认证模式：'api-key'（API 密钥）、'aws-sdk'（AWS SDK）、'oauth'（OAuth）、'token'（Token）。",
  "models.providers.*.api":
    "API 协议类型：openai-completions、openai-responses、anthropic-messages、google-generative-ai、github-copilot、bedrock-converse-stream。",
  "models.providers.*.headers": "发送 API 请求时附加的自定义 HTTP 请求头。",
  "models.providers.*.authHeader": "是否在请求头中包含认证信息。",
  "models.providers.*.models": "该提供商下可用的模型定义列表。",
  "models.providers.*.models.*.id": "模型的唯一标识符（用于 API 调用）。",
  "models.providers.*.models.*.name": "模型的显示名称。",
  "models.providers.*.models.*.api": "覆盖提供商级别的 API 协议（可选）。",
  "models.providers.*.models.*.reasoning": "模型是否支持推理/思考能力。",
  "models.providers.*.models.*.input": "支持的输入类型：text（文本）、image（图像）。",
  "models.providers.*.models.*.contextWindow": "模型的上下文窗口大小（Token 数）。",
  "models.providers.*.models.*.maxTokens": "单次请求的最大输出 Token 数。",
  "models.providers.*.models.*.headers": "模型级别的自定义 HTTP 请求头。",
  "models.providers.*.models.*.cost": "模型使用成本配置（每百万 Token）。",
  "models.providers.*.models.*.cost.input": "输入 Token 成本（每百万 Token）。",
  "models.providers.*.models.*.cost.output": "输出 Token 成本（每百万 Token）。",
  "models.providers.*.models.*.cost.cacheRead": "缓存读取成本（每百万 Token）。",
  "models.providers.*.models.*.cost.cacheWrite": "缓存写入成本（每百万 Token）。",
  "models.providers.*.models.*.compat": "模型兼容性配置。",
  "models.providers.*.models.*.compat.supportsStore": "模型是否支持 store 功能。",
  "models.providers.*.models.*.compat.supportsDeveloperRole": "模型是否支持 developer 角色。",
  "models.providers.*.models.*.compat.supportsReasoningEffort": "模型是否支持推理强度设置。",
  "models.providers.*.models.*.compat.maxTokensField":
    "最大 Token 参数字段名：'max_completion_tokens' 或 'max_tokens'。",
